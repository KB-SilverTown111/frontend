...
import { isAllowedResidentNumberFirstDigit } from '@/features/onboarding/model/contract.js'
import { createRandomDigitOrder, pickDecoyDigits } from '@/features/onboarding/model/screens.js'
