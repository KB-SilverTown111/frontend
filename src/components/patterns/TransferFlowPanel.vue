...
const RECIPIENT_SCREENS = ['2-05', '2-17']
const ACCOUNT_SCREENS = ['2-18']
const AMOUNT_SCREENS = ['2-07']
const CONFIRM_SCREENS = ['2-08']
const RESULT_SCREENS = ['2-14', '2-23']

const showRecipients = computed(() => RECIPIENT_SCREENS.includes(props.screenId))
const showAccounts = computed(() => ACCOUNT_SCREENS.includes(props.screenId))
